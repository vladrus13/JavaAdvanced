...
public class BankImpl implements Bank {
    ...
    @Override
    public Account getLocalAccountByPassport(int passport) throws RemoteException {
        return accounts.values().stream().filter(account -> {
            try {
                return account.getPassport() == passport && account instanceof LocalAccount;
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return false;
    ...
    @Override
    public Account getRemoteAccountByPassport(int passport) throws RemoteException {
        return accounts.values().stream().filter(account -> {
            try {
                return account.getPassport() == passport && account instanceof RemoteAccount;
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return false;
    ...
    @Override
    public boolean containsAmount(String id) throws RemoteException {
